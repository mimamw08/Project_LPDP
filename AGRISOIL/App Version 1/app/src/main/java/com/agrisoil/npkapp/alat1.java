...
public class alat1 extends AppCompatActivity implements AntaresHTTPAPI.OnResponseListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alat1);
        ...
        bck_btn = (ImageView) findViewById(R.id.bck_btn_alat1);
        ...
        bck_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(alat1.this, History_page.class));
            }
        });
        ...
        btnRefresh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                antaresHTTPAPI.getLatestDataofDevice("7a2b707551593efb:f8609170e186f667","AplikasiNPK","Alat-1");
            }
        });
